...
public class Consts {
    ...
    //messages associated with component
    ...
    //messages associated with device
    ...
    //device sql queries
    public static final String GET_ALL_DEVICES = "select id_device, id_component, id_prev, title from device start with id_prev is null connect by prior id_device=id_prev";
    ...
    public static final String GET_NEXT_LEVEL_DEVICE_BY_ID = "select id_device, id_component, id_prev, title from device where level = 1 start with id_prev = ? connect by prior id_device=id_prev";
    public static final String GET_PREV_LEVELS_DEVICE_BY_ID = "select id_device, id_component, id_prev, title from device where level > 1 start with id_device = ? connect by prior id_prev=id_device";
    public static final String GET_NEXT_DEVICE_ID = "select dev_sq.currval from dual";
}
